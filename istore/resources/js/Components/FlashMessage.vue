<template>
  <div>
    <div v-if="$page.props.flash.message !== null && show"
         class="flex items-center justify-between mb-2 w-full bg-green-500 rounded">
    ...
    <div v-if="($page.props.flash.error !== null || Object.keys($page.props.errors).length > 0) && show"
